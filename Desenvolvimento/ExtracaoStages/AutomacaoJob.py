...
def execute_sql_script():
    try:
        ...
        sql_file_path = r'C:\Users\DAniel\Documents\Postgre\Backup_Consultas\CargaFaturamento.sql'
        ...
        with psycopg2.connect(
            ...
            port="3080"        # substitua pela porta que seu banco usa, se for diferente
        ) as conn:
